...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--max-workers", type=int, default=1,
                        help="Max parallel workers for claim extraction (default: 1 = sequential). "
                             "Requires Ollama server `-np >= 2` for speedup.")
...
def _run_gate_wired(model: str, max_candidates: int | None, max_workers: int) -> dict:
