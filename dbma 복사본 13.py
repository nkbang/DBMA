...
#    # 경로 유효성 검사
#    target_dir = st.text_input("RAW 폴더 경로", value="/Users/David/DBMA/data/RAW")
#    output_dir = st.text_input("완성본 폴더 경로", value="/Users/David/DBMA/data/제련완성본")
...
################
    ...
    st.markdown("---")
    st.markdown("### 🔪 청크 설정")
    chunk_size = st.number_input("Chunk Size", value=1200, min_value=100, step=100)
