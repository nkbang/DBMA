...
def _execute_nae_retrieval(query: str) -> list[Any]:
    ...
    try:
        ...
        # [옵션 A] NAE_PARAGRAPH_EVIDENCE(기본 on)면 완성 문단 dict 리스트를,
        # off면 종전 Citation 리스트를 반환한다.
